...
function UGWistiaAPI(){
	...
	this.loadAPI = function(isExternalLoad){
		...
		if(isExternalLoad !== true)
			g_ugFunctions.loadJs("fast.wistia.com/assets/external/E-v1.html", true);
...
function UGSoundCloudAPI(){
	...
	this.loadAPI = function(isExternalLoad){
		...
		if(isExternalLoad !== true)
			g_ugFunctions.loadJs("w.soundcloud.com/player/api.html", true);
...
function UGVimeoAPI(){
	...
	this.loadAPI = function(isExternalLoad){
		...
		if(isExternalLoad !== true)
			g_ugFunctions.loadJs("f.vimeocdn.com/js/froogaloop2.min.html", true);
